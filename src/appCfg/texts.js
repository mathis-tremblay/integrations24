    ...
    info: {
        ...
        infoImportantes: <p>
            ...
            <p><span style={{fontWeight: "bold"}}>AUCUNE ACTIVITÉ N'EST OBLIGATOIRE !</span> Le but des intégrations est
                de vous permettre de connaitre les personnes que vous allez côtoyer pour tout votre bacc et d'avoir du
                fun.
                Vous avez le droit de refuser quoi que ce soit qui vous rend mal à l'aise. La consommation d'alcool
                n'est jamais imposée.
            </p>
            <p>Pour participer aux activités, cochez la case <em>Je participe</em> dans l'onglet Horaire pour chaque
                activité
                que vous souhaitez joindre. Par contre, pour participer, il faut payer !</p>
            <p>Vous pouvez amener vos consommations, mais AUCUN contenant en verre n'est permis.</p>
            <b>Le comité intégrateur 2024</b> <br/>
            <b>GelGif</b>
        </p>,
        frais: <p>
